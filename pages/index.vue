        ...
        <section class="w-full bg-white tails-selected-element">
          <div class="max-w-5xl px-10 py-10 mx-auto xl:px-0">
            <ul class="flex flex-wrap -mx-2 overflow-hidden">
              <li v-for="post in posts" :key="post.id" class="w-full px-2 my-2 overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3">
                <NuxtLink :to="post?.slug">
                  <div
                    class="relative flex items-end justify-center mx-2 overflow-hidden bg-gray-300 rounded-lg group h-96">
                    ...
                    <div class="absolute z-10 w-full h-full bg-gradient-to-b from-transparent to-black opacity-30">
                    </div>
                    <div class="relative z-20 p-5 text-left">
                      <span class="relative inline-block px-3 py-1 -ml-1 text-xs tracking-wide text-white uppercase">
                        ...
                        <span class="hidden relative">Lifestyle</span>
                      </span>
                      <h2 class="my-2 font-serif text-xl font-semibold text-white">{{ post?.title?.rendered }}</h2>
                      <span class="hidden inline-block font-sans text-xs text-white">Top Places</span>
                    </div>
                  </div>
                </NuxtLink>
              </li>
            ...
            <div class="hidden flex flex-wrap mt-10 overflow-hidden">
              <!-- <div class="w-full overflow-hidden md:w-4/6 lg:w-4/6 xl:w-4/6">
                  ...
                  <div class="pb-12">
                    <a href="#_" class="relative block w-full overflow-hidden h-80 rounded-xl">
                      <img
                        ...
                        src="https://cdn.devdojo.com/images/may2021/tails-blog-4.jpg" alt="">
                    </a>
                    <a href="#_"
                      class="relative block mt-5 mb-1 text-xs font-medium tracking-wide text-green-500 uppercase">Travel</a>
                    <h2 class="mb-1 font-serif text-3xl font-thin text-gray-900"><a href="#_">Where to Visit on Your
                        Next Vacation</a></h2>
                    ...
                    <p class="text-gray-800">
                      <span>There are thousands of places you can visit on your next vacation. In this post we'll show
                        you the top destinations to consider for your next adventure...</span>
                  ...
                  <div class="grid grid-cols-12 gap-8">
                    <div class="col-span-12 md:col-span-6">
                      <a href="#_" class="block h-48 mb-3 overflow-hidden rounded-lg">
                        <img
                          ...
                          src="https://cdn.devdojo.com/images/may2021/tails-blog-5.jpg" alt="">
                      </a>
                      <h2 class="mb-2 font-serif text-lg text-gray-900"><a href="#_">Time for the Beach and Friends</a>
                      </h2>
                      <p class="mb-3 text-sm text-gray-800">Many people live so close to amazing scenary, yet they
                        rarely take...
                    ...
                    <div class="col-span-12 md:col-span-6">
                      <a href="#_" class="block h-48 mb-3 overflow-hidden rounded-lg">
                        <img
                          class="object-cover object-center w-full h-full transition duration-300 ease-out transform scale-100 hover:scale-105"
                          src="https://cdn.devdojo.com/images/may2021/tails-blog-6.jpg" alt="">
                      </a>
                      <h2 class="mb-2 font-serif text-lg text-gray-900"><a href="#_">Are you Ready for an
                          Experience?</a></h2>
                      <p class="mb-3 text-sm text-gray-800">Check out these awesome places you'll want to visit as you
                        set your...
                        <a href="#_" class="inline-flex items-center inline ml-1 text-xs text-gray-500 underline">
                          <span>Continue Reading</span>
                          <svg class="w-3 h-3 ml-1 transform -rotate-45" fill="none" stroke="currentColor"
                    ...
                    <div class="col-span-12 md:col-span-6">
                      <a href="#_" class="block h-48 mb-3 overflow-hidden rounded-lg">
                        <img
                          class="object-cover object-center w-full h-full transition duration-300 ease-out transform scale-100 hover:scale-105"
                          src="https://cdn.devdojo.com/images/may2021/tails-blog-7.jpg" alt="">
                      </a>
                      <h2 class="mb-2 font-serif text-lg text-gray-900"><a href="#_">Take Me Back in Time</a></h2>
                      <p class="mb-3 text-sm text-gray-800">How nice would that be to go back in time and enjoy the
                        youth...
                        <a href="#_" class="inline-flex items-center inline ml-1 text-xs text-gray-500 underline">
                          <span>Continue Reading</span>
                          <svg class="w-3 h-3 ml-1 transform -rotate-45" fill="none" stroke="currentColor"
                    ...
                    <div class="col-span-12 md:col-span-6">
                      <a href="#_" class="block h-48 mb-3 overflow-hidden rounded-lg">
                        <img
                          class="object-cover object-center w-full h-full transition duration-300 ease-out transform scale-100 hover:scale-105"
                          src="https://cdn.devdojo.com/images/may2021/tails-blog-8.jpg" alt="">
                      </a>
                      <h2 class="mb-2 font-serif text-lg text-gray-900"><a href="#_">Here are the Best Ways to Train</a>
                      </h2>
                      <p class="mb-3 text-sm text-gray-800">Learn about the best ways to train to get the most of your
                        workout...
                        <a href="#_" class="inline-flex items-center inline ml-1 text-xs text-gray-500 underline">
                          <span>Continue Reading</span>
                          <svg class="w-3 h-3 ml-1 transform -rotate-45" fill="none" stroke="currentColor"
                ...
                <div class="mt-10 text-center">
                  <button
                    class="px-5 py-3 mt-5 text-sm font-medium tracking-widest text-white uppercase bg-gray-900 rounded-lg">Load
                      ...
                      <form action="">
                        <div class="mt-5 overflow-hidden bg-white border-none rounded-lg">
                          <input
                            ...
                            type="text" name="name" id="" placeholder="First Name">
                        </div>
                        <div class="mt-5 overflow-hidden bg-white border-none rounded-lg">
                          <input
                            class="w-full px-3 py-2 placeholder-gray-400 bg-transparent border-2 border-gray-200 rounded-lg focus:outline-none"
                        ...
                        <button type="submit"
                          class="w-full py-3 mt-5 text-sm font-medium tracking-widest text-white uppercase bg-gray-900 rounded-lg">Subscribe</button>
                      </form>
                    </div>
                  </div>
                  <div class="mt-10">
                    ...
                    <ul>
                      <li class="mb-5">
                        <a href="#_" class="flex">
                          ...
                          <div class="flex flex-col items-start justify-center w-2/3 p-2">
                            <h3 class="mb-2 font-serif font-thin text-gray-900">Top Destinations to Visit in the World
                            </h3>
                      ...
                      <li class="mb-5">
                        <a href="#_" class="flex">
                          ...
                          <div class="flex flex-col items-start justify-center w-2/3 p-2">
                            <h3 class="mb-2 font-serif font-thin text-gray-900">Experience the Future of the 3d Gaming
                              Experience</h3>
